...
<Feature
	header="AI Security for Apps"
	href="/waf/detections/ai-security-for-apps/"
>
	Protect LLM-powered applications from prompt injection attacks, PII exposure,
	and unsafe topics. Use AI detection fields in custom rules to monitor and
	mitigate threats specific to large language models (LLMs).
</Feature>
